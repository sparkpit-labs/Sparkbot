      ...
      <section className="command-grid" aria-label="Capability limits">
        <article className="command-panel">
          <div className="command-panel-heading">
            ...
            <p>Provider credentials stay server-side. Chat and Round Table can use configured provider routes when available.</p>
          </div>
        ...
        <article className="command-panel">
          ...
          <div className="connector-grid">
            {["Round Table connector actions", "Connector sends", "File/process execution", "Scheduler jobs", "Physical device control"].map((item) => (
