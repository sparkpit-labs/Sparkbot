      ...
      <section className="command-grid" id="seats" aria-labelledby="seats-heading">
        <article className="command-panel command-panel-wide">
          <div className="command-panel-heading">
            ...
            <p>Seat assignment and model routing controls are active; Chat uses the selected configured provider route, and Round Table uses configured seat routes when available.</p>
          </div>
