...
- `docs/LIMA_PROVIDER_GUARDIAN_ADAPTER.md`, `scripts/run-lima-provider-adapter-contract-smoke.sh`, and `scripts/smoke-check-lima-provider-adapter.sh` for the Codex/Claude subscription dispatch boundary through a configured localhost LIMA Guardian adapter.
