...
- `docs/LIMA_PROVIDER_GUARDIAN_ADAPTER.md` and `scripts/smoke-check-lima-provider-adapter.sh` for the Codex/Claude subscription dispatch boundary through a configured localhost LIMA Guardian adapter.
